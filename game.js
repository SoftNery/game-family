 ...
 *    f = [x, y, w, h] do corpo em cada quadro: de ONDE ler os pixels
 *        (sobras soltas nas bordas já removidas)
 *    g = onde esse quadro deve APARECER, quando difere de f. Existe porque
 *        alguns arquivos foram regerados fora de escala e desalinhados: g
 *        devolve o tamanho e a linha do chão corretos sem tocar na arte.
...
const ATLAS = {
  ...
  'filho-correndo-jogando-brinquedo': { n: 5, u: [0,112,342.8,477], p: 251.3, f: [[27,112,264,471],[0,116,292,454],[0,125,295,460],[32,148,291,404],[52,129,268,459]], g: [[27,112,264,471],[0,116,292,454],[0,125,295,460],[12.2,130,330.6,459],[52,129,268,459]] },
  'filho-correndo-jogando-fralda': { n: 5, u: [0,75,375.8,515], p: 272.5, f: [[30,75,283,509],[0,79,314,490],[0,88,312,498],[32,122,329,455],[39,93,293,497]], g: [[30,75,283,509],[0,79,314,490],[0,88,312,498],[17.2,94,358.6,496],[39,93,293,497]] },
  ...
  'filho-tropecando': { n: 6, u: [15.9,122,342.1,463], p: 243.4, f: [[42,124,313,461],[32,147,298,406],[32,183,298,334],[59,207,299,369],[74,216,261,356],[25,122,309,458]], g: [[42,124,313,461],[18.8,139,324.4,442],[15.9,212,330.1,370],[59,207,299,369],[74,216,261,356],[25,122,309,458]] },
  'mae-atingida-por-objeto': { n: 5, u: [10.7,68,413.6,535], p: 300.5, f: [[79,81,338,521],[32,110,371,479],[47,74,339,523],[15,76,382,527],[14,83,339,519]], g: [[79,81,338,521],[10.7,68,413.6,534],[47,74,339,523],[15,76,382,527],[14,83,339,519]] },
  'mae-cansada': { n: 5, u: [0,79,396,540], p: 298.2, f: [[58,79,338,533],[32,80,333,539],[59,86,323,533],[26,221,326,396],[0,205,342,409]], g: [[58,79,338,533],[40.6,107,315.7,511],[59,86,323,533],[26,221,326,396],[0,205,342,409]] },
  ...
  'mae-pegando-filho': { n: 5, u: [-18.8,52,472.5,548], p: 306.5, f: [[32,160,371,380],[32,103,371,494],[32,72,371,556],[102,55,317,545],[58,52,305,548]], g: [[-18.8,76,472.5,484],[45.9,119,343.2,457],[36.7,55,361.7,542],[102,55,317,545],[58,52,305,548]] },
  'mae-pulando': { n: 5, u: [26,36,377,576], p: 265.5, f: [[107,203,296,400],[51,121,324,447],[52,36,323,416],[26,129,356,448],[43,193,301,419]] },
  'mae-tropecando': { n: 6, u: [-35,119,432.1,465], p: 272.5, f: [[32,175,298,350],[0,124,352,443],[32,200,298,300],[32,201,298,298],[12,216,322,356],[0,121,302,462]], g: [[-17,119,395.9,465],[0,124,352,443],[-35,144,432.1,435],[18.5,241,325,325],[12,216,322,356],[0,121,302,462]] },
...
function buildFrameCache(assets) {
  for (const seq of Object.keys(SCALES)) {
    ...
    const list = [];
    for (let i = 0; i < a.n; i++) {
      const f = a.f[i];              // de onde ler no PNG
      const g = a.g ? a.g[i] : f;    // onde deve aparecer (corrige arte fora de escala)
      const img = assets.get(frameFile(seq, i));
      const w = Math.max(1, Math.round(g[2] * s));
      const h = Math.max(1, Math.round(g[3] * s));
      ...
      list.push({ c: cv, dx: (g[0] - anchorX) * s, dy: (g[1] - anchorY) * s, w, h });
    }
    FRAMES[seq] = list;
  }
}
